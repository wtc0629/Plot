...
newtest2 = test.loc[test['process'] == "horizontally_GestureTime0"]
print(newtest2)
...
for j in gestures:
    ...
    for i in range(8):
        ...
        if j == 'near to far' or j == 'near to far fast':
            ...
            #newtest.quiver(x='gaze_point_3d_y', y='gaze_point_3d_z',u=testdiff['gaze_point_3d_y'], v=testdiff['gaze_point_3d_z'])
            ...
            #newtest.quiver(x='gaze_point_3d_x', y='gaze_point_3d_y', title=j + ' x-y ' + str(i))
